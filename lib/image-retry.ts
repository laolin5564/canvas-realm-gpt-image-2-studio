...
const nonRetryablePatterns =
  /(content[_\s-]?policy|content[_\s-]?filter|moderation|safety system|invalid[_\s-]?request|invalid[_\s-]?prompt|invalid parameter|unsupported|内容审核|内容政策|违规|涉及敏感|参数错误|不支持|缺少参考图|参考图压缩后仍超过|图片路径不合法)/i;
